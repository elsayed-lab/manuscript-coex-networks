...
df <- read_csv('input/indiv_network_stats/6.0/networks_hsall.csv')
...
```{r load_data, message=FALSE}
df <- read_csv('input/indiv_network_stats/6.0/networks_mmlm.csv')
```
...
```{r load_data, message=FALSE}
df <- read_csv('input/indiv_network_stats/6.0/networks_lmmm.csv')
```
...
```{r load_data, message=FALSE}
df <- read_csv('input/indiv_network_stats/6.0/networks_lmhs.csv') 
```
...
```{r load_data, message=FALSE}
df <- read_csv('input/indiv_network_stats/6.0/networks_tchs.csv')
```
