...
MANUSCRIPT_CONFIG <- list(
    ...
    adjmat_hslm_inf      = 'output/7.0/03-consensus-network-construction/data/adjmat_hslm-inf.rda',
    adjmat_hslm_uninf    = 'output/7.0/03-consensus-network-construction/data/adjmat_hslm-uninf.rda',
    adjmat_hstc_inf      = 'output/7.0/03-consensus-network-construction/data/adjmat_hstc-inf.rda',
    adjmat_hstc_uninf    = 'output/7.0/03-consensus-network-construction/data/adjmat_hstc-uninf.rda'
)
