...
MANUSCRIPT_CONFIG <- list(
    ...
    adjmat_inf          = 'output/7.0/03-consensus-network-construction/data/adjmat_hstc-inf.rda',
    adjmat_uninf        = 'output/7.0/03-consensus-network-construction/data/adjmat_hstc-uninf.rda',
    xangle=90,
    xhjust=0.5
)
