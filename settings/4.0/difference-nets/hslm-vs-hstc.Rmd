...
MANUSCRIPT_CONFIG <- list(
    ...
    adjmat_hslm_inf      = 'output/4.0/03-consensus-network-construction/data/adjmat_hstc-inf.rda',
    adjmat_hslm_uninf    = 'output/4.0/03-consensus-network-construction/data/adjmat_hstc-uninf.rda'
)
