...
MANUSCRIPT_CONFIG <- list(
    ...
    adjmat_inf      = 'output/4.0/03-consensus-network-construction/data/adjmat_hslm-inf.rda',
    adjmat_uninf    = 'output/4.0/03-consensus-network-construction/data/adjmat_hslm-uninf.rda'
)
