...
```{r child='child/02-hslm-inf.Rmd', eval=MANUSCRIPT_CONFIG$output_prefix == 'hslm-inf'}
```

```{r child='child/02-hstc-inf.Rmd', eval=MANUSCRIPT_CONFIG$output_prefix == 'hstc-inf'}
```
...
html_filepath <- file.path(output_prefix, paste0('consesus_network_', MANUSCRIPT_CONFIG$output_prefix, '.html'))
