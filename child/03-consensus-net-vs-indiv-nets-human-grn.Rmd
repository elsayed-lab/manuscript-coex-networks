...
coop::pcor(consensus_edge_weights, tf_mapping_subset$edge_weight_scaled, method='spearman')
...
for (net_id in sample_nets$id) {
    ...
    # correlation with Marbach TF-regulatory network edge weights
    message(coop::pcor(indiv_edge_weights, tf_mapping_subset$edge_weight, method='spearman'))
}
