...
consensus_val <- median(adjmat_scaled[adjmat_scaled != 0])
...
consensus_val <- median(apply(adjmat_scaled, 1, function(x) { sum(x != 0) / nrow(adjmat_scaled) }))
...
consensus_val <- median(apply(adjmat_scaled, 1, function(x) { median(x[x != 0]) }))
