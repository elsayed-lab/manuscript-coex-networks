...
combined_counts <- combine_replicates(cpm_counts, condition)
expr_diff <- combined_counts[[CONFIG$main_comparison[2]]] - combined_counts[[CONFIG$main_comparison[1]]] 
dendrogram_colors = cbind(dendrogram_colors, expr_diff)
