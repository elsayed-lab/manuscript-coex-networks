...
for (i in 1:length(input_nets)) {
    ...
    # TESTING
    message('---')
    message("Adjacency matrix subsets:")
    message(paste(names(adjmats), collapse = ' / '))
    message(paste(sapply(adjmats, length), collapse = ' / '))
    message('---')
...
# 2017/12/25: disabling filtering-related results for now (slow...)
