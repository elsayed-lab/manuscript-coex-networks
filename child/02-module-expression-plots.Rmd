...
```{r large_scale_features, results='asis'}
...
```{r expression_profiles, message=FALSE, warning=FALSE, fig.show='hold', fig.height=5.0625, fig.width=9, results='hide'}
# long version of counts
counts_long <- cbind(gene_id=rownames(count_table), cpm_counts)
