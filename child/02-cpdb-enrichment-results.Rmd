...
gene_cpdb_pathways <- gene_cpdb_mapping %>% 
    filter(category %in% enriched_cpdb_paths & gene %in% gene_info$gene_id)
...
cat(sprintf(template, 
            ...
            length(unique(gene_cpdb_mapping$category)),
...
cpdb_paths_of_interest <- 'Cytokine|Antigen|TNF|immune|Chagas|Toll'
