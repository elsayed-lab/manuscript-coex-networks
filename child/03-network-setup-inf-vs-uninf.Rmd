```{r inf_vs_uninf_setup, results='asis', fig.height=1080/192}
...
par(mfrow=c(1,2))
hist(inf, main="Raw Edge Weights (Infected)", xlab='Edge Weight', cex=1.6)
hist(uninf, main="Raw Edge Weights (Uninfected)", xlab='Edge Weight', cex=1.6)
```
...
```{r normalize_edge_weight_distibutions, fig.height=1080/192}
...
par(mfrow=c(1,2))
hist(inf, main="Normalized Edge Weights (Infected)", xlab='Edge Weight', cex=1.6)
hist(uninf, main="Normalized Edge Weights (Uninfected)", xlab='Edge Weight', cex=1.6)
```
