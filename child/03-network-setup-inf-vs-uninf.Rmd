...
par(mfrow=c(2,1))
hist(inf, main="Raw Edge Weights (Infected)", xlab='Edge Weight', cex=1.5)
hist(uninf, main="Raw Edge Weights (Uninfected)", xlab='Edge Weight', cex=1.5)
```
...
par(mfrow=c(1,2))
hist(inf, main="Normalized Edge Weights (Infected)", xlab='Edge Weight', cex=1.5)
hist(uninf, main="Normalized Edge Weights (Uninfected)", xlab='Edge Weight', cex=1.5)
```
