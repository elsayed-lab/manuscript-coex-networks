...
params:
  ...
  version: ""
  analysis_dirname: "03-network-construction"
...
if (opts_knit$get("rmarkdown.pandoc.to") == 'latex') {
    system(sprintf('(sleep 30 && mv 03-network-comparison.pdf %s) &', pdf_filepath))
} else {
    system(sprintf('(sleep 30 && mv 03-network-comparison.html %s) &', html_filepath))
}
```
