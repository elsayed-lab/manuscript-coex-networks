...
```{r load_adj_mat}
infile <- sub('03-consensus-network-construction', '02-consensus-network-filtering',
...
if (opts_knit$get("rmarkdown.pandoc.to") == 'latex') {
    system(sprintf('(sleep 30 && mv 03-consensus-network-construction.pdf %s) &', html_filepath))
} else {
